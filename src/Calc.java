...
//В описании к требованиям не было указано, как должна вести себя программа, если в результате вычислений
//мы получаем отрицательное число или 0 при использовании латинских цифр.
//поэтому я не сделал на них исключения, так как я понимаю, что они имеют место быть, указал для латинских цифр
//"Negative value " - если число отрицательное и "Nulla" - если в результате вычислений получен 0
